...
void GPIO_Config (void)
{
	...
	temp &= 0x3C0FCCCC;		//PA0 analog input; PA2, PA4, PA6 output;
	temp |= 0x40501113;		//PA10, PA11 output; PA12 input; PA15 out
	GPIOA->MODER = temp;
	...
	temp &= 0x3F0FCCCF;
	temp |= 0x00000000;		//PA2, PA4, PA6, PA10, PA11, PA15 low speed
	GPIOA->OSPEEDR = temp;

	temp = GPIOA->PUPDR;	//2 bits por pin
	temp &= 0xFCFFFFFF;
	temp |= 0x01000000;		//PA12 pull up
	GPIOA->PUPDR = temp;
	...
	temp &= 0xFFFFFFFF;
	temp |= 0x00000000;		//PB6 open drain PB7 push pull
	GPIOB->OTYPER = temp;
	...
	temp &= 0xFFFFFFFF;		//PB1 PB3 pull up
	temp |= 0x00000000;
	GPIOB->PUPDR = temp;
